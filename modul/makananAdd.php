...
<body>
    <div class="container">
        <div class="form-header">
            ...
            <p class="form-subtitle">Kelola data kuliner nusantara dalam database</p>
        </div>
            ...
            <form method="post" action="?page=<?= isset($data) ? 'makananUpdateProses' : 'makananAddProses' ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_makanan" class="form-input"
                        value="<?= isset($data) ? htmlspecialchars($data['nama_makanan']) : '' ?>"
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="daerah_makanan" class="form-input"
                        value="<?= isset($data) ? htmlspecialchars($data['daerah_makanan']) : '' ?>"
